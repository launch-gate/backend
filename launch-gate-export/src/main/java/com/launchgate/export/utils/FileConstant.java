...
public class FileConstant {
     ...
     */
    public static String EXPORT_FILE_BASE_NAME = "contest-ranking";

    /**
     * Шаблон названия выгрузки.
     * [Название файла]-[Время создания файла].[Расширение файла]
     */
    public static String EXPORT_FILE_NAME_TEMPLATE = "%s-%s.%s";
     ...
     */
    public static MediaType MEDIA_TYPE_XLSX = MediaType.parseMediaType("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");

    /**
     * MIME-тип для передачи текстовых файлов в формате (.csv).
     */
    public static MediaType MEDIA_TYPE_CSV = MediaType.valueOf("text/csv");
}
